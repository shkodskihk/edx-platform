...
function($, Backbone, _, gettext, moment, ViewUtils, HtmlUtils, StringUtils, TranscriptSettingsTemplate,
    ...
    CourseVideoSettingsView = Backbone.View.extend({
        ...
        getSourceTranslations: function() {
            var sourceTranslations = null;
            if (this.selectedProvider === THREE_PLAY_MEDIA) {
                sourceTranslations = this.availableTranscriptionPlans[this.selectedProvider].translations;
            }
        ...
        getTargetLanguages: function() {
            ...
            if (selectedPlan && this.selectedProvider === CIELO24 && this.selectedFidelityPlan) {
                availableLanguages = selectedPlan.fidelity[this.selectedFidelityPlan].languages;
            } else if (selectedPlan && this.selectedProvider === THREE_PLAY_MEDIA) {
        ...
        renderVideoSourceLanguageMenu: function() {
            var self = this,
                availableLanguages = self.getTargetLanguages(),
                availableTranslations = self.getSourceTranslations(),
        ...
        populateLanguageMenu: function() {
            ...
            if (this.selectedProvider === THREE_PLAY_MEDIA) {
                ...
                availableLanguages = _.pick(
                    availableLanguages,
                    this.getSourceTranslations()[this.selectedVideoSourceLanguage]
                );
            }
